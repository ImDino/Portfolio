...
let tlreverse = gsap.timeline({ paused: true, reversed: true });
    let tl2 = gsap.timeline({ paused: true, reversed: true });
let tlreverse2 = gsap.timeline({ paused: true, reversed: true });
    let tl3 = gsap.timeline({ paused: true, reversed: true });
let tlreverse3 = gsap.timeline({ paused: true, reversed: true });

    tl.to('#page-1-nav', {opacity: 1, ease: "none"});
    tlreverse.to('#page-1-nav',{opacity: 0, ease: "none"});
    ...
    tl2.to('#page-2-nav', {opacity: 1, ease: "none"});
    tlreverse2.to('#page-2-nav',{opacity: 0, ease: "none"});
    ...
    tl3.to('#page-3-nav', {opacity: 1, ease: "none"});
    tlreverse3.to('#page-3-nav',{opacity: 0, ease: "none"});
