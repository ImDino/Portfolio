...
// let tlreverse = gsap.timeline({ paused: true, reversed: true });
    ...
    tl.to('#page-2-nav', {opacity: 1, ease: "none"});
    // tlreverse.to('#page-2-nav',{opacity: 0, ease: "none"});
    ...
    tl.to('#page-3-nav', {opacity: 1, ease: "none"});
    // tlreverse.to('#page-3-nav',{opacity: 0, ease: "none"});
