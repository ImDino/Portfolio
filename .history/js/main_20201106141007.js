document.addEventListener('DOMContentLoaded', () => {
    ...
    let nav1 = gsap.timeline({
        ...
        scrollTrigger: {
            // trigger: header,
            // pin: true,   // pin the trigger element while active
            start: "600  middle", // when the top of the trigger hits the top of the viewport
            end: "+=20", // end after scrolling 500px beyond the start
            scrub: 1, // smooth scrubbing, takes 1 second to "catch up" to the scrollbar
            // snap: {
            //     snapTo: "labels", // snap to the closest label in the timeline
    ...
    let nav2 = gsap.timeline({
        ...
        scrollTrigger: {
            // trigger: header,
            // pin: true,   // pin the trigger element while active
            start: "4000  middle", // when the top of the trigger hits the top of the viewport
            end: "+=20", // end after scrolling 500px beyond the start
            scrub: 1, // smooth scrubbing, takes 1 second to "catch up" to the scrollbar
            // snap: {
            //     snapTo: "labels", // snap to the closest label in the timeline
    ...
    nav1.addLabel('nav2').from('#page-2-nav', {opacity:0})
